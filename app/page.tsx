        ...
        <div className="wrap">
          ...
          <div className="pricing-grid">
            <div className="plan">
              ...
              <Link href="#kontak" className="btn btn-ghost" style={{ justifyContent: "center" }}>Pilih Starter</Link>
            </div>
            <div className="plan popular">
              ...
              <Link href="#kontak" className="btn btn-primary" style={{ justifyContent: "center" }}>Pilih Business</Link>
            </div>
            <div className="plan">
              <h3>Pro / Custom</h3>
              ...
              <Link href="#kontak" className="btn btn-ghost" style={{ justifyContent: "center" }}>Diskusikan Kebutuhan</Link>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="foot-top">
            ...
            <div className="foot-cols">
              <div className="foot-col">
                <h4>LAYANAN</h4>
                <Link href="#layanan">Landing Page</Link>
                <Link href="#layanan">Company Profile</Link>
                <Link href="#layanan">Toko Online</Link>
                <Link href="#layanan">Web App Custom</Link>
              </div>
              <div className="foot-col">
                <h4>PERUSAHAAN</h4>
